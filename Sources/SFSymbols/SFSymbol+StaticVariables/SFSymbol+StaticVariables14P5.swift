...
public extension SFSymbol {
    /// airpodsmax
    /// - Since: iOS: 14.5, macOS: 11.3, tvOS: 14.5, watchOS: 7.4
    ...
    /// character.bubble.ar
    /// - Since: iOS: 14.5, macOS: 11.3, tvOS: 14.5, watchOS: 7.4
    static let characterBubbleAr = SFSymbol(
        title: "character.bubble.ar",
        categories: [.communication],
        searchTerms: nil,
        releaseInfo: ReleaseInfo(iOS: 14.5, macOS: 11.3, tvOS: 14.5, watchOS: 7.4)
    )
    ...
    /// character.bubble.he
    /// - Since: iOS: 14.5, macOS: 11.3, tvOS: 14.5, watchOS: 7.4
    static let characterBubbleHe = SFSymbol(
        title: "character.bubble.he",
        categories: [.communication],
        searchTerms: nil,
        releaseInfo: ReleaseInfo(iOS: 14.5, macOS: 11.3, tvOS: 14.5, watchOS: 7.4)
    )
