...
public extension SFSymbol {
    /// aqi.high
    /// - Since: iOS: 14.2, macOS: 11.0, tvOS: 14.2, watchOS: 7.1
    ...
    /// - Since: iOS: 14.2, macOS: 11.0, tvOS: 14.2, watchOS: 7.1
    static let docTextBelowEcgFillRtl = SFSymbol(
        title: "doc.text.below.ecg.fill.rtl",
        categories: nil,
        searchTerms: nil,
        releaseInfo: ReleaseInfo(iOS: 14.2, macOS: 11.0, tvOS: 14.2, watchOS: 7.1)
    )
    ...
    /// - Since: iOS: 14.2, macOS: 11.0, tvOS: 14.2, watchOS: 7.1
    static let docTextBelowEcgRtl = SFSymbol(
        title: "doc.text.below.ecg.rtl",
        categories: nil,
        searchTerms: nil,
        releaseInfo: ReleaseInfo(iOS: 14.2, macOS: 11.0, tvOS: 14.2, watchOS: 7.1)
    )
